...
const Hero = () => {
    ...
    return (
      ...
      <section className="bg-dark-purple font-quicksand text-white">
  ...
  >
    <div className="mx-auto text-center">
      <h1
        className=" bg-gradient-to-r p-4 from-green-100 via-pink to-purple-600 bg-clip-text font-extrabold text-transparent text-7xl"
      >
        Partagez.
        Apprennez.
        Echangez
      ...
      BetwinUp première plateforme gratuite d'échange de compétences.
